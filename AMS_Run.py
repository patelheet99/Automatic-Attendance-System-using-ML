...
def manually_fill():
    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            ENR = tk.Label(MFW, text="Enter ID", width=15, height=2, fg="white", bg="blue2",
                           font=('times', 15, ' bold '))
...
AP = tk.Button(window, text="Check Register Employee",command=admin_panel,fg="black"  ,bg="pale goldenrod"  ,width=19 ,height=1, activebackground = "Red" ,font=('times', 15, ' bold '))
...
FA = tk.Button(window, text="Automatic Attendace",fg="black",command=subjectchoose  ,bg="alice blue"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
